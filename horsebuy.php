...
<body>
    <div class="container">
        ...
        $sql = "SELECT name, phone, address, location, breed, age, amount, description, image FROM horse";
        ...
        if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
                ...
                echo '<button class="call-button" onclick="call(\'' . $row["phone"] . '\')">Call</button>';
                echo '</div>';
                echo '</div>';
            }
        } else {
